    ...
    <form action="/profile/{{$lists['profiles'] -> user_id}}" method="POST" enctype="multipart/form-data">
      ...
      <div class="row row-cols-lg-3 g-3 align-items-center mb-3">
        ...
        <div class="col-12">
          ...
          <input type="date" class="form-control @error('birth_date') is-invalid @enderror" id="birth_date" name="birth_date" value="{{$lists['profiles'] -> birth_date}}">
          @error('birth_date')
          <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
          </span>
      ...
      <div class="row row-cols-lg-3 g-3 align-items-center mb-3">
        ...
        <div class="col-12">
          ...
          <input type="date" class="form-control @error('volunteering_date') is-invalid @enderror" id="volunteering_date" name="volunteering_date" value="{{$lists['profiles'] -> volunteering_date}}">
